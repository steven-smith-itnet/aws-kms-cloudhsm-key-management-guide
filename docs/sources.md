...
| Cloud | Guide |
|:--|:--|
| Azure | [Azure Key Vault &amp; Managed HSM Key Management Guide](https://smittystuff.github.io/azure-key-vault-managed-hsm-key-management-guide/) |
| Google Cloud | [Google Cloud KMS &amp; Cloud HSM Key Management Guide](https://smittystuff.github.io/gcp-cloud-kms-hsm-key-management-guide/) |

---

## About this guide

Prepared by [SmittyStuff](https://github.com/SmittyStuff) as an independent
...
[View this guide on GitHub](https://github.com/SmittyStuff/aws-kms-cloudhsm-key-management-guide){: .btn }
